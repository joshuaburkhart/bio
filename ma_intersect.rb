...
common_genes = Hash.new(Array.new)
line_count = 0
...
puts "Intersection contains #{common_genes_ary.length}/#{line_count} = #{common_genes_ary.length / line_count}% of original genes."
